...
class ATM(nn.Module):
    def __init__(self,
        ...
        self.cam_enc_dec = ED_Transformer(depth=cam_layer_depth, embed_dim=cam_embed_dim, mlp_hidden_dim=cam_embed_dim*2, 
    ...
    def forward(self, x, is_train=False, J_regressor=None) :
        ...
        cam_feat = self.cam_enc_dec(cam_feat)
        ...
        pose_shape_feat = self.pose_shape_encoder(pose_shape_feat)
