...
from lib.models.AccumulatedToken.Regressor import regressor_output, Total_Regressor
from lib.models.smpl import SMPL, SMPL_MODEL_DIR
from lib.models.Warp.Gaussian import Gaussian_Fusing
...
class ATM(nn.Module):
    def __init__(self,
        ...
        self.warp_feat = Gaussian_Fusing(seqlen=seqlen, embed_dim=embed_dim)
